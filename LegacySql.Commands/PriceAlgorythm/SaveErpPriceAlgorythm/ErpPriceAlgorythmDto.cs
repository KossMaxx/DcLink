...
{
    public class ErpPriceAlgorythmDto
    {
        ...
        public IEnumerable<ErpPriceAlgorythmDetailDto> Details { get; set; }
        public IEnumerable<ErpPriceAlgorythmSettingDto> Settings { get; set; }
    }
}
