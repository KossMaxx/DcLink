...
{
    public class ClientOrderItemArchivalConfiguration : IEntityTypeConfiguration<ClientOrderItemArchivalEF>
    {
        public void Configure(EntityTypeBuilder<ClientOrderItemArchivalEF> builder)
        {
            ...
            builder.HasMany(e => e.SerialNumbers)
                .WithOne(e => e.ClientOrderItemArchival)
                .HasForeignKey(e => e.ClientOrderItemArchivalId);
